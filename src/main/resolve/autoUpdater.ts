...
export async function checkUpdate(): Promise<AppVersion | undefined> {
  ...
  let url = 'https://github.com/d2184/sparkle/releases/latest/download/latest.yml'
  if (updateChannel == 'beta') {
    url = 'https://github.com/d2184/sparkle/releases/download/pre-release/latest.yml'
  }
...
export async function downloadAndInstallUpdate(version: string): Promise<void> {
  ...
  const baseUrl = `https://github.com/d2184/sparkle/releases/download/${releaseTag}/`
  const fileMap = {
